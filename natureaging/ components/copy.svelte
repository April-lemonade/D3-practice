...
<div class="chart-container" bind:clientWidth={width}>
    <svg
        {width}
        {height}
        style="background-color: #FAFAFA;transform:translate(0%,-8%)"
    >
        <g id="falling">
            <g id="g1">
                <path
...
<style>
    ...
    .head {
        transform: translate(19%, 56%) scale(1);
